...
ProcessChain::ProcessChain()
    : ObjectWrap(), mLastPid(-1), mLaunched(false), mInteractive(false), mShellPgid(-1), mPgid(-1),
      mShellTermios(0), mType(Foreground), mStatus(Running), mStdoutClosed(false)
{
...
NAN_METHOD(ProcessChain::New)
{
    ...
    if (args.Length() != 2) {
        return NanThrowError("ProcessChain needs a jsh object and a foreground/background argument");
    }
