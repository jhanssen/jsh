...
private:
    ...
    enum State { Regular, Continue };
    void foreground(pid_t pgid, State state = Regular);
    void background(pid_t pgid, State state = Regular);

    static v8::Handle<v8::Value> New(const v8::Arguments& args);
    static v8::Handle<v8::Value> chain(const v8::Arguments& args);
    static v8::Handle<v8::Value> write(const v8::Arguments& args);
    static v8::Handle<v8::Value> end(const v8::Arguments& args);
    static v8::Handle<v8::Value> foreground(const v8::Arguments& args);
    static v8::Handle<v8::Value> background(const v8::Arguments& args);
