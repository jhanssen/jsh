...
function registerService(name, cb)
{
    ...
    function connectToServer()
    {
        ...
        socket.connect(socketFile, function() {
            connected = true;
    ...
    {
        var child = child_process.fork(__filename, ['--module-path=' + serviceFile, '--socket-file=' + socketFile]);
...
function launchService(modulePath, socketPath)
{
    ...
    console.log("Launching here on server side", modulePath, socketPath, module);
    var connections = [];
    ...
    server.on('listening', function() { process.send({ready:true}); });
...
if (typeof process !== 'undefined') {
    ...
    if (modulePath && socketFile) {
        launchService(modulePath, socketFile);
    }
}
